      ...
      <div className="base:w-[95%] max-w-[1920px] lg:w-[97.5%]">
        ...
        <div className="base:flex base:flex-col lg:grid grid-cols-12">
          <div className="row-span-full col-start-1 col-end-11 flex w-full flex-col z-50">
            ...
            <div
              className={`lg:inline-block base:hidden w-[32rem] text-black text-[min(1.5vw,1.4rem)]  italic  pt-[9rem] ${poppinsMedium.className}`}
            >
          ...
          <div className="row-span-full lg:pl-[5rem] col-start-7 col-end-13 row-start-1 row-end-3 z-0">
            <Image
              className="w-full rounded-br-[4rem] base:h-[fit]  md:h-[min(45vw,700px)] object-cover"
              src={Ceo}
              alt="Our Founder - Opuvlence"
            />
          </div>

          {/*for mobile  */}
          <div
            className={`lg:hidden base:inline-block tracking-[0.03em]  base:text-[1rem] md:text-[2.6vw] base:w-[75.315vw] md:w-[48vw] font-extrabold italic ${poppins}`}
          >
            &apos;Lorem Ipsum dolor sit amet consectetur adipscing lore lorem is
            lorem ipsum dolor sit amet adipscing Lorem Ipsum dolor sit
            amet&apos;
          </div>
        </div>
        <div
          className={`${poppinsRegular.className} base:hidden lg:inline-block  base:text-[1rem] lg:text-[1rem] base:text-right lg:text-left py-11 text-black lg:leading-8 font-normal md:text-[2.4vw] lg:ml-[25rem] lg:mr-[5rem]`}
        >
          ...
          result.
          <br />
          Overall, if you&apos;re looking for an interior company that can
          provide you with personalized and high-quality service, then
          we&apos;re the right choice for you.
        </div>
        <div
          className={`${poppinsRegular.className} lg:hidden base:inline-block  base:text-[1rem] lg:text-[1rem] base:text-right lg:text-left py-11 text-black lg:leading-8 font-normal md:text-[2.4vw] lg:ml-[25rem] lg:mr-[5rem]`}
        >
          We emphasize the importance of quality materials, as they are integral
          to creating lasting and beautiful interior designs. Client
          satisfaction remains our utmost priority, and we strive to exceed
          their expectations with each project. If you seek personalized and
          high-quality service, we are the ideal interior company for you. Your
