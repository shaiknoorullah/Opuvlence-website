      ...
      <div className="base:w-[95%] max-w-[1920px] lg:w-[97.5%]">
        ...
        <div className="base:flex base:flex-col lg:grid grid-cols-12">
          <div className="row-span-full col-start-1 col-end-11 flex w-full flex-col z-50">
            ...
            >
              “ We understand that the details matter in interior design. We pay
              close attention to every aspect of the project to ensure that the
              end result is exactly what our clients are looking for”
            </div>
          </div>
        ...
        >
          ...
          creating beautiful and long-lasting interior designs. That's why we
          only use the best materials in all of our projects.
          <br />
          ...
          result.
          <br /> Overall, if you're looking for an interior company that can
          provide you with personalized and high-quality service, then we're the
