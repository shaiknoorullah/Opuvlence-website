    ...
    <div className=" w-[100%] relative z-[1000] flex justify-center base:px-[20px] base:mt-5 lg:mt-0 lg:px-[40px]  ">
      ...
      >
        <div className="flex flex-col base:items-center base:w-[100%]  lg:w-[max(970px,50vw)] lg:items-start justify-start gap-[30px]">
          <h1
            data-scroll
            className="m-0 text-[#270405] base:text-[24px] md:text-[4.94vw]  md:leading-[6.77vw] md:tracking-[0.175em] 2xl:tracking-[10px] lg:tracking-[7px]  xl:text-[62px] 2xl:text-[78px] uppercase font-[300] lg:leading-[min(5vw,90px)] 2xl:leading-[100px] "
          >
            <div
          ...
          {/* image for mobile */}
          <div className="lg:hidden base:inline-block base:w-[280px] md:w-[max(360px,45.87vw)] base:h-[350px] md:h-[min(480px,67.5vh)] relative overflow-clip  rounded-tl-full rounded-tr-full">
            <Image
              className="  lg:top-0 lg:right-[10] object-fill md:h-[28rem]"
