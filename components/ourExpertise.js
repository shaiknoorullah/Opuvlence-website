    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={`${poppinsExtrabold.className} uppercase font-extrabold text-[1.2rem] md:text-[2rem] text-[#A5787A] flex`}
          >
            <span className="inline-block text-[1rem] md:text-[2rem] mr-3">/</span>
        ...
        <div
          id="section-title"
          className={`${poppinsRegular.className} lg:w-[30%] base:text-[1.5rem] md:text-[2.8rem] lg:text-[1.8rem] lg:text-left base:text-center text-black leading-[2.4rem] md:leading-[4rem] font-[700] pt-8`}
        >
        ...
        <div className="w-full grid base:grid-cols-2 lg:grid-cols-11 pt-9">
          <div class="col-span-6  w-full grid lg:grid-rows-3">
            ...
            <div
              id="section-button"
              class="row-span-1 hidden lg2:flex  items-center"
            >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="bg-[#A5787A] rounded-tl-full  w-full base:h-[9rem] md:h-[18rem] lg:h-[min(15vw,22rem)]"></div>
              <div
                className={`text-[#A5787A] base:text-[0.8rem] md:text-[1.3rem] font-semibold italic ${poppinsRegular.className}`}
              >
                RESTAURANT
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="bg-[#443C3D] md:h-[29rem] rounded-t-full w-full base:h-[14.5rem] lg:h-[min(25vw,34rem)]"></div>
              <div
                className={`${poppinsRegular.className} base:text-[0.8rem] md:text-[1.3rem] text-[#A5787A]  font-semibold italic `}
              >
                RESIDENTIAL
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="bg-[#AB9D9E] md:h-[24rem] rounded-tr-full w-full base:h-[11rem] lg:h-[min(20vw,28rem)]"></div>
              <div
                className={`text-[#A5787A] base:text-[0.8rem] md:text-[1.3rem] font-semibold italic ${poppinsRegular.className} `}
              >
                CORPORATE
        ...
        >
          <div className="lg:text-[0.9rem] base:text-[1.2rem] md:text-[1.8rem]  font-medium  text-center text-[#A5787A] md:leading-[2rem] base:leading-[1.5rem]">
