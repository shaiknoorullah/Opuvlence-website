...
const Navbar = () => {
  ...
  useEffect(() => {
    if (buttonRef.current) {
      ...
      buttonRefVar.addEventListener("mouseenter", handleMouseEnter);
      buttonRefVar.addEventListener("mouseleave", handleMouseLeave);
      buttonRefVar.addEventListener("click", handleButtonClick);
      navLinksRefVar.addEventListener("click", handleButtonClick2);
      navLinksRefVar2.addEventListener("click", handleButtonClick2);
      return () => {
        buttonRefVar.removeEventListener("mouseenter", handleMouseEnter);
        buttonRefVar.removeEventListener("mouseleave", handleMouseLeave);
        buttonRefVar.removeEventListener("click", handleButtonClick);
        navLinksRefVar.removeEventListener("click", handleButtonClick2);
        navLinksRefVar2.addEventListener("click", handleButtonClick);
      };
    }
  }, [isClicked]);
              ...
              >
                ...
                <NavLinks
                  ...
                  href={
                    data.title === "Cases"
                      ? {
                          pathname: "/caseslibrary",
                          query: { active: "Residential" },
                        }
                      : data.href
                  }
                  className={
                    "cursor-pointer hover:-translate-x-3 transition-transform ease-out w-fit hover:text-black text-gray-500 "
                  }
                >
                  {data.title}
                </NavLinks>
