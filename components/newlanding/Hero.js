      ...
      <div className="bgmobile my-11 p-6 lg:mt-0 base:mt-24 lg:w-[80%] base:w-[90%] max-w-[1920px] py-[7vw] flex flex-col text-[#F6EBDD]  justify-between">
        <div className="w-full flex lg:flex-row base:flex-col justify-between h-full z-50">
          <div className="gap-[7vw] lg:w-[50%] h-full  flex flex-col">
            ...
            <div className="gap-[3vw] flex flex-col justify-center">
              <div className="timerbg py-8  base:w-[100%] lg:w-[min(75%,28rem)] lg:justify-center lg:items-center flex flex-col gap-9 lg:gap-[min(1.8vw,1.8rem)]">
                {" "}
                <CountdownTimer />
        ...
        {/* hero bottom images */}
        {/* <div className="w-full hidden lg:flex base:flex-col lg:flex-row gap-9 lg: pt-14">
        ...
        <div className="hidden lg:flex gap-9 z-[99999] pt-[100px] ">
          <Image src={GoogleRating} className="md:w-[min(22vw,356px)] " />
          <Image src={TrustPilot} className="md:w-[min(22vw,356px)] " />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className=" flex base:text-[1.9rem] base:mt-2 md:mt-0 lg:text-[min(3vw,42px)]  ">
      <div className="lg:text-[#FF3333]   base:text-[#ffffff]">
        <span className="border-[0.65px] lg:text-[#FF3333] base:text-[#ffffff] mr-1 font-[300]  rounded-md lg:border-[#FF3333] base:border-[#ffffff] p-3  lg:p-[min(1vw,1rem)]">
          {countdown.days}
        </span>
        :
      </div>
      <div className="lg:text-[#FF3333] base:text-[#ffffff]">
        <span className="border-[0.65px] lg:text-[#FF3333] base:text-[#ffffff] mx-1 font-[300] rounded-md lg:border-[#FF3333] base:border-[#ffffff] p-3  lg:p-[min(1vw,1rem)]">
          {countdown.hours}
        </span>
        :
      </div>
      ...
      <div>
        <span className="border lg:text-[#FF3333] base:text-[#ffffff] font-[300] mx-1 rounded-md lg:border-[#FF3333] base:border-[#ffffff] p-3  lg:p-[min(1vw,1rem)]">
          {countdown.seconds}
        </span>
      </div>
    </div>
