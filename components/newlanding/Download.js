      ...
      <div className="w-[90%]">
        <div className="flex base:flex-col md:flex-row py-[min(5.2vw,100px)] px-[min(2.60vw,50px)] bg-[#270405] gap-[min(16.14vw,310px)]">
          <div className="flex flex-col base:gap-[20px] md:gap-[min(1.5vw,30px)]">
            <div className="text-[#F6EBDD] font-[Gilroy] md:text-[min(2.3vw,45px)] font-bold">
              Download your Free Opuvlence Design Guide Now!
            </div>
            <div className="text-[#F6EBDD] font-[Gilroy] text-[min(4vw,25px)] md:text-[min(1.09vw,21px)]">
            ...
            <button className="bg-[#F6EBDD] text-[#270405] md:w-[min(12.5vw,241px)] rounded-sm py-[min(0.9vw,18px)] md:text-[min(0.9vw,18px)] font-[900] items-center">
              Download PDF
              <span className=""> &#8595;</span>
            </button>
          </div>
