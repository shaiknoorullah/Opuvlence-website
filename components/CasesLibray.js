    ...
    <Link href={props.href} passHref>
      <div className="block cursor-pointer base:h-[299px] md:h-[663px] lg:h-[820px]">
        <div className="w-[100%] h-[100%] relative flex flex-col justify-center items-center overflow-clip ">
          ...
          <div
            className={`font-normal z-[99] relative base:w-[80vw] base:text-[3.43vw]  lg:w-[min(480px,25vw)] items-center italic lg:text-[min(23px,1.197vw)] lg:leading-[min(31.6px,1.645vw)] tracking-[0.1em] text-center text-black lowercase ${poppins.className}`}
          >
            {props.text}
          </div>
          <Image
