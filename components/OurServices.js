			...
			<div className="w-[95%] lg:w-[97.5%] flex flex-col">
				...
				<div className="flex flex-col lg:grid grid-cols-12 ">
					<div className="flex row-span-full flex-col col-start-1 col-end-8  z-50">
						<div
							className={`base:text-[2.8rem] text-black lg:text-[6.3vw] tracking-[0.7rem] lg:tracking-[1rem] lg:leading-[170px] ${golden.className}`}
						>
					...
					<div className="row-span-full flex-col col-start-7 col-end-13 z-0 base:my-5 lg:my-0">
						<img
							className="base:h-[22rem] lg:h-fit"
							src="/serviceshero.jpg"
						/>
					</div>
					<div className="col-start-5 text-black lg:ml-[6rem] w-[90%] leading-8 font-semibold lg:mt-[-7rem] ml-5 col-end-9 italic base:text-[1.1rem] lg:text-[1.5rem] z-[100] ">
