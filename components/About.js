...
const About = () => {
  return (
    <div className="w-[100%]  base:flex jus relative lg:flex flex-col max-w-[1920px] base:mt-[4rem] lg:mt-[-10rem]">
      <div
        className={`lg:w-[65%]  flex justify-center base:text-[3.75vw] md:text-[1.5rem] base:leading-[5.62vw] base:tracking-[0.15vw] base:pt-[5vw] base:pb-[6.40vw] 3xl:text-[25px] 3xl:leading-[37.5px] 3xl:tracking-[0.5px] font-extrabold text-[#A5787A] 3xl:pt-[20px] 3xl:pb-[41px] lg:text-[1.2626vw] lg:leading-[1.89vw] lg:pt-[1.01vw] lg:pb-[2.07vw] uppercase ${poppins.className}`}
      >
      ...
      <div className="base:pl-[6.25vw] base:pr-[6.25vw] 3xl:pl-[191px] 3xl:pr-[191px] lg:pl-[9.64vw] lg:pr-[9.64vw] lg:flex lg:flex-row relative lg:gap-[11.41vw] 3xl:gap-[226px] z-[100]">
        <div
          data-scroll
          data-scroll-speed="2"
          className={`base:w-[60.56vw] base:text-[8.88vw] md:w-[100vw] md:text-[6.6rem] base:leading-[14.88vw] base:tracking-[2.46vw] 3xl:w-[656px] 3xl:text-[115px] 3xl:leading-[157.32px] 3xl:tracking-[17.5px] font-normal ${golden.className} lg:text-[5.80vw] lg:leading-[7.94vw] lg:tracking-[0.88vw] lg:w-[33.1313vw] text-black`}
        >
          get to kno
        ...
        >
          ...
          <div data-scroll data-scroll-speed="1.5">
            <div className="text-right base:text-[white] md:text-[black]">
              A
            </div>
            <div className="md:text-[white] text-right base:text-[black]">
              lit
