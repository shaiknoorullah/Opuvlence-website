...
const About = () => {
  const { targetRef: imageRef, isIntersecting } = useAnimateOnScroll(1);
  ...
  return (
    ...
    >
      ...
      <div className="base:pl-[6.25vw] max-w-[80%] base:pr-[6.25vw] 3xl:pl-[191px] 3xl:pr-[191px] lg:pl-[9.64vw] lg:pr-[9.64vw] base:hidden lg:flex lg:flex-row relative lg:gap-[11.41vw] 3xl:gap-[226px] z-[100]">
        <div
          id="textLeft"
          className={`base:w-[60.56vw] z-[1000] overflow-hidden opacity-0 absolute top-0 left-0 base:text-[8.88vw] base:leading-[14.88vw] base:tracking-[2.46vw] 3xl:w-[656px] 3xl:text-[115px] 3xl:leading-[157.32px] 3xl:tracking-[17.5px] font-normal ${golden.className} lg:text-[5.80vw] lg:leading-[7.94vw] lg:tracking-[0.88vw] lg:w-[33.1313vw] text-black`}
        >
          get to know
          <br />
          us
      ...
      {/* mpible page */}
      <div className="lg:hidden relative text-black  w-full text-[min(10vw,6rem)] mt-12 py-[6rem] ">
        <Image
          src={Getmobile}
          className="w-[100%] relative rounded-[5rem] md:px-10"
        />
        <div
          className={`absolute top-0 z-[1000]  ${golden.className} md:ml-5  flex flex-col gap-6`}
        >
          <div>GET TO</div>
          <div>KNOW</div>
