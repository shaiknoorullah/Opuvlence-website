...
// 		setprojects(residential)
		
// 	}
// 	if (active==="restaurant") {
// 		setprojects(restaurant)
      ...
      <div className="font-poppins w-[98%] z-50 ">
        <div className="grid grid-cols-[1.3fr_0.4fr_1.2fr_1.2fr] grid-rows-[0.4fr_0.6fr_0.7fr_0.5fr_0.4fr]">
          <div
            ...
            className="w-[100%] justify-center font-extrabold base:text-[1.3rem] md:text-[2rem] text-[#A5787A] flex pt-[20px]"
          >
            / OUR PROJECTS
          </div>
          <text
          ...
          >
            <div className="flex text-black flex-row items-center 3xl:gap-[15px] lg:gap-[0.78vw] absolute 3xl:top-[-13.59px] lg:top-[-0.708vw]">
              <div
                ...
                className={
                  active === "Residential"
                    ? `font-medium 3xl:text-[22.15px]  3xl:leading-[33.22px] lg:text-[1.153vw] lg:leading-[1.73vw] tracking-[0.5%]  italic uppercase`
                    : `font-normal 3xl:text-[22.15px] cursor-pointer  3xl:leading-[33.22px] lg:text-[1.153vw] lg:leading-[1.73vw] tracking-[0.5%]  italic uppercase`
                }
              >
                residential
              </div>
