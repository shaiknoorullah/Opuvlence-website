...
const ExampleComponent = () => {
	...
	return (
		<div className="absolute top-0 pointer-events-none left-0 w-full h-screen ">
			<div
				ref={contentRef}
				className={`relative z-[999999] flex flex-col ${golden.className} overflow-clip justify-center text-[200px] h-screen w-full items-center text-[#A5787A] bg-[#340506]`}
			>
				<h1
					id="opuvlence"
					className="absolute top-[27vh] text-[12vw]"
				>
					Opuvlence
				</h1>
				<p
					id="desc"
					className={`absolute md:top-[70vh] base:top-[57vh] md:left-[35vw] base:left-[4.5vw] ${poppins.className} md:w-[436px] base:w-fit text-center md:text-[28px] base:text-[16px] z-[100]`}
				>
