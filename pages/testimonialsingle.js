...
const Testimonialsingle = () => {
	return (
		<div className="w-full flex flex-col cursor-none justify-center text-black">
			<div className="w-[95%] base:py-12 lg:py-9 flex lg:flex-row base:flex-col">
				...
				<div className="flex  text-black flex-col base:py-3 lg:my-[9rem] lg:pl-[3rem] lg:w-[75%]">
