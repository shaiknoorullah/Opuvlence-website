...
export default function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>Opuvlence - Luxury Interior Design Services</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="opuvlence, interior design, luxury, residential, commercial, hospitality"
        />
        <meta name="author" content="Opuvlence" />
        ...
        <meta property="og:url" content="https://www.opuvlence.com" />
        ...
        <meta name="twitter:creator" content="@opuvlence" />
      </Head>
